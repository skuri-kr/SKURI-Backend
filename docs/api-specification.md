...
> 변경 이력
> - 2026-08-24: 택시 정원·친구 초대 보완 — 정원 자동 모집 마감 제거, CLOSED 참가자 초대·리더 승인, join request의 `invitationInviterName`, EXPIRED 수신자의 DELETE→DISMISSED 목록 삭제 계약을 `/v3/api-docs` 기준으로 추가
