...
public final class OpenApiChatSchemas {

    private OpenApiChatSchemas() {
    }

    @Schema(name = "ChatRoomSummaryListApiResponse", description = "공통 API 응답 포맷")
    public record ChatRoomSummaryListApiResponse(
            @Schema(description = "요청 성공 여부")
            boolean success,
            @Schema(description = "성공 시 응답 데이터", nullable = true)
            List<ChatRoomSummaryResponse> data,
    ...
    @Schema(name = "ChatRoomDetailApiResponse", description = "공통 API 응답 포맷")
    public record ChatRoomDetailApiResponse(
            @Schema(description = "요청 성공 여부")
            boolean success,
            @Schema(description = "성공 시 응답 데이터", nullable = true)
    ...
    @Schema(name = "ChatMessagePageApiResponse", description = "공통 API 응답 포맷")
    public record ChatMessagePageApiResponse(
            @Schema(description = "요청 성공 여부")
            boolean success,
            @Schema(description = "성공 시 응답 데이터", nullable = true)
    ...
    @Schema(name = "ChatReadUpdateApiResponse", description = "공통 API 응답 포맷")
    public record ChatReadUpdateApiResponse(
            @Schema(description = "요청 성공 여부")
            boolean success,
            @Schema(description = "성공 시 응답 데이터", nullable = true)
            ChatReadUpdateResponse data,
            @Schema(description = "에러 메시지", nullable = true)
            String message,
            @Schema(description = "에러 코드", nullable = true)
            String errorCode,
    ...
    @Schema(name = "ChatRoomSettingsApiResponse", description = "공통 API 응답 포맷")
    public record ChatRoomSettingsApiResponse(
            @Schema(description = "요청 성공 여부")
            boolean success,
            @Schema(description = "성공 시 응답 데이터", nullable = true)
            ChatRoomSettingsResponse data,
            @Schema(description = "에러 메시지", nullable = true)
            String message,
            @Schema(description = "에러 코드", nullable = true)
            String errorCode,
    ...
    @Schema(name = "AdminCreateChatRoomApiResponse", description = "공통 API 응답 포맷")
    public record AdminCreateChatRoomApiResponse(
            @Schema(description = "요청 성공 여부")
            boolean success,
            @Schema(description = "성공 시 응답 데이터", nullable = true)
